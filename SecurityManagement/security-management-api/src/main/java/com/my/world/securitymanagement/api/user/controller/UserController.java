...
import com.my.world.common.rest.validator.NewPOValidatorGroup;
...
public class UserController {
    ...
    public TableViewResult getUserList(@UrlRequestObject RequestQueryCondition requestQueryCondition) {
