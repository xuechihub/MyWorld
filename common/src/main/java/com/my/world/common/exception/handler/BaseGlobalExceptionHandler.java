package com.my.world.common.exception.handler;

import com.my.world.common.enums.ResultCode;
import com.my.world.common.exception.BusinessException;
...
public class BaseGlobalExceptionHandler {
    ...
    protected DefaultErrorResult handleConstraintViolationException(ConstraintViolationException e, HttpServletRequest request) {
        ...
        return DefaultErrorResult.failure(ResultCode.PARAM_IS_INVALID, e, HttpStatus.BAD_REQUEST, parameterInvaildItemList);
    }
